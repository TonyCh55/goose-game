...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(SCREEN_WIDTH, random.randint(0, SCREEN_HEIGHT), *enemy_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(0, SCREEN_WIDTH), 0, *bonus_size)
    bonus_move = [0, 1]
...
while playing:
    ...
    for bonus in bonuses:
        if bonus[1].bottom > SCREEN_HEIGHT:
